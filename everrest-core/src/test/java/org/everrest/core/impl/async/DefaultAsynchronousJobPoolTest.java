...
public class DefaultAsynchronousJobPoolTest {
    @Rule
    ...
    private DefaultAsynchronousJobPool asynchronousJobPool;
    ...
    public void setUp() throws Exception {
        ...
        asynchronousJobPool = new DefaultAsynchronousJobPool(configuration);
    ...
    private GenericContainerRequest mockContainerRequest() {
        ...
        ConfigurationProperties requestProperties = mock(ConfigurationProperties.class);
        when(containerRequest.getProperties()).thenReturn(requestProperties);
