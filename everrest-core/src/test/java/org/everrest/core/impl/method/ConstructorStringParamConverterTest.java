...
public class ConstructorStringParamConverterTest {
    private ConstructorStringParamConverter<Integer> converter;

    @Before
    public void setUp() throws Exception {
        converter = new ConstructorStringParamConverter<>(Integer.class.getConstructor(String.class));
    }
